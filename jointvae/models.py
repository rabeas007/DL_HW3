...
class VAE(nn.Module):
    def __init__(self, img_size, latent_spec, temperature=.67, use_cuda=False):
        ...
        latent_spec : dict
            ...
            {'cont': 10, 'disc': [10, 5, 5, 2]} encodes 10 normal variables and
            2 gumbel softmax variables of dimension 10, 5 and 5. A latent spec
        ...
        # Map encoded features into a hidden vector which will be used to encode parameters of the latent distribution
    ...
    def encode(self, x):
        """
        Encodes an image into parameters of a latent distribution defined in self.latent_spec.
    ...
    def sample_gumbel_softmax(self, alpha):
        ...
        if self.training:
            ...
            # max_alpha. Note the view is because scatter_ only accepts 2D tensors.
